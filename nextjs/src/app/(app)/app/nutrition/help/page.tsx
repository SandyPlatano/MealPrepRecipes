  ...
  return (
    <div className="container max-w-4xl space-y-8 py-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Nutrition Tracking Help</h1>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Batch Processing Existing Recipes</CardTitle>
          <CardDescription>Extract nutrition for multiple recipes at once</CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          <p className="text-sm text-muted-foreground">
            If you have many existing recipes without nutrition data, use the batch extraction tool:
          </p>
          <ol className="list-decimal list-inside space-y-2 text-sm">
            <li>Go to Nutrition → Batch Extract</li>
            <li>Set batch size (recommended: 10-20 recipes)</li>
            <li>Click &quot;Check Recipes&quot; to see how many need processing</li>
            <li>Click &quot;Extract Nutrition&quot; to start processing</li>
            <li>Review results and retry any failures</li>
          </ol>
          <Alert>
            <Info className="h-4 w-4" />
            <AlertDescription className="text-sm">
              Process recipes in smaller batches (10-20 at a time) to avoid rate limits and ensure better results.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            <p className="font-medium text-sm">Batch extraction failing?</p>
            <p className="text-sm text-muted-foreground mt-1">
              Reduce batch size to 5-10 recipes → Review ingredient lists
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Complete guide with advanced features
              </p>
            </div>
            <Button variant="outline" size="sm" asChild>
              <a
                href="https://github.com/yourusername/MealPrepRecipes/blob/main/NUTRITION_TRACKING_GUIDE.md"
                target="_blank"
