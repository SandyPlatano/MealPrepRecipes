    ...
    return (
      <Card className="overflow-hidden transition-shadow hover:shadow-md h-full min-h-[140px]">
        <CardContent className="p-4 flex flex-col gap-4 h-full">
          ...
          {showNutrition && calculatedNutritionProgress && (
            <>
              <div className="h-px bg-border" />
              <div className="flex items-center gap-3 text-xs">
                ...
                <div className="flex gap-3 flex-wrap">
                  <span className="font-mono">
                    {calculatedNutritionProgress.totals.calories > 0
                      ? `${Math.round(calculatedNutritionProgress.totals.calories / 7)}/day cal`
                      : "—"
                    }
                  </span>
                  <span className="font-mono text-muted-foreground">
                    {calculatedNutritionProgress.totals.protein > 0
                      ? `${Math.round(calculatedNutritionProgress.totals.protein / 7)}g protein`
                      : ""
                    }
                  </span>
                </div>
