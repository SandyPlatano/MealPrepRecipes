...
export async function sendShoppingListEmail({
  ...
  // Upload files to Supabase Storage if available (for working download links)
...
<body>
  ...
  <p><small>Generated by Meal Prep Recipe Manager</small></p>
    ...
    const htmlResult = await uploadShoppingListFile(htmlContent, htmlFilename, 'text/html');
    if (htmlResult.success) {
      htmlFileUrl = htmlResult.url;
    } else {
      console.warn('Failed to upload HTML file to Supabase Storage:', htmlResult.error);
    }
  }
      ...
      try {
        ...
        if (attachmentContent) {
          ...
          if (markdownFileUrl) {
            ...
            templateParams.has_download_links = 'true';
            templateParams.download_section_message = 'Download your shopping list as a file. Click the buttons below to download.';
          } else {
            ...
            templateParams.has_download_links = 'false';
          ...
          if (htmlFileUrl) {
            templateParams.shopping_list_download_link_html = htmlFileUrl;
            templateParams.shopping_list_download_filename_html = filename.replace('.md', '.html');
            templateParams.has_html_download = 'true';
          } else {
            templateParams.shopping_list_download_link_html = '';
            templateParams.shopping_list_download_filename_html = '';
            templateParams.has_html_download = 'false';
          }
  ...
  <div class="email-container">
    ...
    <div class="content">
      ...
      <div class="section" style="margin-top: 32px; padding-top: 24px; border-top: 2px solid #e5e5e5;">
        ...
        {{#if shopping_list_download_link}}
        <div style="text-align: center; margin: 20px 0;">
          ...
          {{#if shopping_list_download_link_html}}
        ...
        <p style="color: #737373; font-size: 12px; margin-top: 12px; font-style: italic;">
          <strong>Tip:</strong> Click the buttons above to download your shopping list. The files will open in your browser - you can then save them to your device.
        </p>
        {{/if}}
        {{#if storage_error_message}}
        <p style="color: #ef4444; font-size: 12px; margin-top: 8px; font-style: italic;">
          Note: {{storage_error_message}}
        </p>
        {{/if}}
      </div>
